...
export const STAR: Record<VisualState, StarStyle> = {
  attention: { core: '#ffd873', glow: '#ffb020', r: 12, gr: 52, solid: true },
  ...
  available_next: { core: '#8ed7ac', glow: '#3b9f68', r: 10, gr: 42, solid: false },
  team_work: { core: '#b9a7ee', glow: '#775dc1', r: 9, gr: 36, solid: true },
